                    ...
                    <div class="pagination">
                        ...
                        <c:if test="${pageDto.totalCount gt 0}">
                            ...
                            <c:if test="${pageDto.startPage gt pageDto.pageBlock }">
                                <a href="cardList?companyCode=${companyCode}&strPageNum=${pageDto.startPage - pageDto.pageBlock}"
                                   class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
                            </c:if>
                            <!-- 페이지번호 -->
                            <c:forEach var="i" begin="${pageDto.startPage}" end="${pageDto.endPage}" step="1">
                                <c:if test="${i==pageDto.pageNum}">
                                    <a href="cardList?companyCode=${companyCode}&strPageNum=${i}"
                                       class="active">${i}</a>
                                </c:if>
                                <c:if test="${i!=pageDto.pageNum }">
                ...
                <c:if test="${companyCode==null}">
                    <div class="pagination">
                        ...
                        <c:if test="${pageDto.totalCount gt 0}">
                            ...
                            <c:if test="${pageDto.startPage gt pageDto.pageBlock }">
                                <a href="cardAllList&strPageNum=${pageDto.startPage - pageDto.pageBlock}&field=${field}&word=${word}"
                                   class="prev-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a>
                            </c:if>
                            <!-- 페이지번호 -->
                            <c:forEach var="i" begin="${pageDto.startPage}" end="${pageDto.endPage}" step="1">
                                <c:if test="${i==pageDto.pageNum}">
                                    <a href="cardAllList?strPageNum=${i}&field=${field}&word=${word}"
                                       class="active">${i}</a>
                                </c:if>
                                <c:if test="${i!=pageDto.pageNum }">
