		...
		<div class="main-content">
			<section id="welcome">
				<div class="content-header">
					<h1>Karma Shop Html5 Responsive Template</h1>
				</div>
				<div class="welcome">

					<h2 class="twenty">Welcome To Karma Shop Html5 Responsive Template</h2>
					<p>Firstly, a huge thanks for purchasing this theme, your support is truly appreciated!</p>
					<p>This document covers the installation and use of this theme and often reveals answers to common problems and
						issues - read this document thoroughly if you are experiencing any difficulties. If you have any questions that
						are beyond the scope of this document, feel free to email at <code><a href="mailto:support@colorlib.com">support@colorlib.com</a></code>
						Thank you so much!</p>
				</div>
			...
			<section id="installation">
				...
				<div class="section-content">
					<ol>
						...
						<li>You can view this Template in any browser, you can display or edit the Template without an internet
							connection.(May not wotrk fonts and google map).</li>
						<li>The only section that will not work is the Contact Section which contains PHP code and requires a server
							environment for send messages.</li>
			...
			<section id="tmpl-structure">
				...
				<p class="fifteen">All information within the main content area is nested within a body tag. The general template
					structure is pretty the same throughout the template. Here is the general structure of main page (index.html).</p>
			...
			<section id="css-structure">
				...
				<p>By default, the template loads this font from Google Web Font Services, you can change the font with the one
			...
			<section id="javascript">
				...
				<p class="fifteen">These are the list of Javascript files that are loaded into templates in end of the <strong>Body
						Section</strong>.
