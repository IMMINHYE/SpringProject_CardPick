            ...
            <div class="row">
                <div class="col-lg-8 col-md-8">
                    ...
                    <form action="join" method="post" id="frm">
                        ...
                        <div class="mt-10">
                            <input type="text" name="userId" id="userId" placeholder="id" onfocus="this.placeholder = ''" onblur="this.placeholder = 'id'"
                                   required class="single-input" oninput="checkId()">
                            <span id = "chkMsg"></span>
                        </div>
                        <div class="mt-10">
                            <input type="text" name="username" id="username" placeholder="name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'name'"
                                   required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="password" name="userpass" id="userpass" placeholder="password" oninput="pwCheck(userpass.value)"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'password'"
                                   required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="password" name="userpass_check" id="userpass_check" placeholder="password confirm" onfocus="this.placeholder = ''" onblur="this.placeholder = 'password confirm'"
                                   required class="single-input">
                        </div>
                        <p id="pwCheckF" style="color: #FF6600; margin: 0;"></p>
                        <p id="pwCheckFF" style="color: #FF6600; margin: 0;"></p>
                        <div class="mt-10">
                            <input type="text" name="userphone" id="userphone" placeholder="phone number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'phone number'"
                                   required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="email" name="useremail" id="useremail" placeholder="Email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'"
                                   required class="single-input">
                        </div>
                        <div class="mt-10">
                            <input type="button" onclick="execPostCode();" value="주소검색" class="genric-btn primary small" />
                        </div>
                        <div class="mt-10">
                            <input type="text" id="useraddr2"  name="useraddr2" placeholder="도로명주소" class="single-input" readonly="readonly">
                        </div>
                        <div class="mt-10">
                        ...
                        <div class="mt-10">
                            ...
                            <input type="radio" id="profile" name="profile" value="resources/img/profile/p1.png" checked>
