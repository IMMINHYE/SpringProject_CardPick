                                            ...
                                            <td>
                                                <div class="media">
                                                    <div class="media-body">
                                                        <a href="cardView?cardId=${favList.fav.cardId}"><img class="img-fluid" src="${favList.card.cardImg}" alt=""></a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <a href="cardView?cardId=${favList.fav.cardId}"><h4>${favList.card.cardName}</h4></a><br>
                                                <h6>💳카드사 : ${favList.card.card_company}</h6><br>
                                                <h6>💰연회비 : ${favList.card.anual_fee}</h6><br>
                                                <h6>🏆실적 : ${favList.card.achievement}</h6><br>
                                            </td>
                                            <td>
                                                <a href=""  id="favDeleteBtn" data-favId="${favList.fav.favId}" class="genric-btn info small">삭제</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
